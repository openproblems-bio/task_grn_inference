...
- Our paper in biorxiv `geneRNIB: a living benchmark for gene regulatory network inference <https://www.biorxiv.org/content/10.1101/2025.02.25.640181v1.full.pdf>`_ 
- The `GitHub page <https://github.com/openproblems-bio/task_grn_inference>`_ on the OpenProblems platform. 
