#!/usr/bin/env python3
"""
Quick test of improved VC implementation
"""
...
test_par = {
    ...
    'score': 'output/test_improved_vc.h5ad',
    'genes_n': 5000
}

if __name__ == "__main__":
    print("=== Testing Improved VC Implementation ===")
    print(f"Prediction file: {test_par['prediction']}")
    print(f"Evaluation file: {test_par['evaluation_data']}")
    print()
    
    try:
        # Import and run improved VC
        from improved_helper import main as improved_main
        print("Running improved VC...")
        
        result = improved_main(test_par)
