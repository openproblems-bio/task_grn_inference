// batch_correction_seurat build-main
// 
    ...
    "arguments" : [
      ...
      },
      {
        ...
        "info" : {
          ...
          "summary" : "Perturbation dataset for benchmarking.",
          "type" : "file",
          "example" : "resources/grn-benchmark/perturbation_data.h5ad",
          "info" : {
            "label" : "perturbation",
            "summary" : "Perturbation dataset for benchmarking.",
            "file_type" : "h5ad",
    ...
    "resources" : [
      {
        ...
        "path" : "script.R",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/task_grn_inference/task_grn_inference/src/process_data/perturbation/batch_correction_seurat/"
      }
    ],
    "test_resources" : [
      {
...
par <- list(
  "perturbation_data_n" = $( if [ ! -z ${VIASH_PAR_PERTURBATION_DATA_N+x} ]; then echo -n "'"; echo -n "$VIASH_PAR_PERTURBATION_DATA_N" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "'"; else echo NULL; fi ),
  "perturbation_data_bc" = $( if [ ! -z ${VIASH_PAR_PERTURBATION_DATA_BC+x} ]; then echo -n "'"; echo -n "$VIASH_PAR_PERTURBATION_DATA_BC" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "'"; else echo NULL; fi )
)
meta <- list(
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_grn_inference/perturbation/batch_correction_seurat",
    "tag" : "build-main"
  },
  "label" : [
    "midtime",
