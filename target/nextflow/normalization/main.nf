...
meta = [
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/task_grn_benchmark/task_grn_benchmark/src/process_data/perturbation/normalization/"
      }
    ],
    "info" : {
      "label" : "normalization",
  ...
  "info" : {
    ...
    "platform" : "nextflow",
    "output" : "/home/runner/work/task_grn_benchmark/task_grn_benchmark/target/nextflow/normalization",
    "viash_version" : "0.8.6",
...
par = {
  'perturbation_data_f': $( if [ ! -z ${VIASH_PAR_PERTURBATION_DATA_F+x} ]; then echo "r'${VIASH_PAR_PERTURBATION_DATA_F//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_grn_inference/normalization",
    "tag" : "build-main"
  },
  "label" : [
    "midtime",
