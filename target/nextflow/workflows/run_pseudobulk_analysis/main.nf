// run_pseudobulk_analysis build_main
// 
...
meta = [
  ...
  "info" : {
    "label" : "Pseudobulk analysis",
    "summary" : "Pseudobulk scRNA-seq and evaluates the scores"
  },
  "status" : "enabled",
  "scope" : {
    "image" : "public",
  ...
  "dependencies" : [
    ...
    {
      "name" : "stability_analysis/pseudobulk_rna",
      "repository" : {
        "type" : "local"
      }
    },
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_grn_inference/task_grn_inference/src/workflows/stability_analysis/run_pseudobulk_analysis/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
...
include { pseudobulk_rna } from "${meta.resources_dir}/../../../nextflow/stability_analysis/pseudobulk_rna/main.nf"
