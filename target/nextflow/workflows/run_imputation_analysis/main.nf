// run_imputation_analysis build_main
// 
...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_grn_inference/task_grn_inference/src/workflows/stability_analysis/run_imputation_analysis/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
    "output" : "target/nextflow/workflows/run_imputation_analysis",
    "viash_version" : "0.9.4",
...
include { impute_rna } from "${meta.resources_dir}/../../../nextflow/stability_analysis/impute_rna/main.nf"
