...
meta = [
    ...
    "resources" : [
      {
        ...
        "path" : "main.nf",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/task_grn_benchmark/task_grn_benchmark/src/workflows/run_grn_inference/",
        "entrypoint" : "run_wf"
      }
    ],
    "info" : {
      "label" : "run_grn_inference",
      "summary" : "Infers GRNs from multiomics data using GRN inference methods."
    },
    "status" : "enabled",
    "dependencies" : [
      {
  ...
  "info" : {
    "config" : "/home/runner/work/task_grn_benchmark/task_grn_benchmark/src/workflows/run_grn_inference/config.vsh.yaml",
    "platform" : "nextflow",
