...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_grn_inference/task_grn_inference/src/workflows/run_grn_inference/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
