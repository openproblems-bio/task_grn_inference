...
meta = [
  ...
  "functionality" : {
    ...
    "arguments" : [
      ...
      },
      {
        ...
        "name" : "--hvgs",
        "default" : [
          "resources/grn-benchmark/supp/hvgs.csv"
        ],
        "must_exist" : true,
        "create_parent" : true,
        "required" : true,
    ...
    "resources" : [
      {
        ...
        "path" : "script.R",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/task_grn_benchmark/task_grn_benchmark/src/process_data/explanatory_analysis/hvgs/"
      }
    ],
    "info" : {
      "label" : "hvgs",
  ...
  "info" : {
    "config" : "/home/runner/work/task_grn_benchmark/task_grn_benchmark/src/process_data/explanatory_analysis/hvgs/config.vsh.yaml",
    "platform" : "nextflow",
    "output" : "/home/runner/work/task_grn_benchmark/task_grn_benchmark/target/nextflow/hvgs",
    "viash_version" : "0.8.6",
...
par <- list(
  "perturbation_data" = $( if [ ! -z ${VIASH_PAR_PERTURBATION_DATA+x} ]; then echo -n "'"; echo -n "$VIASH_PAR_PERTURBATION_DATA" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "'"; else echo NULL; fi ),
  ...
  "n_hvgs" = $( if [ ! -z ${VIASH_PAR_N_HVGS+x} ]; then echo -n "as.integer('"; echo -n "$VIASH_PAR_N_HVGS" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "')"; else echo NULL; fi ),
  "hvgs" = $( if [ ! -z ${VIASH_PAR_HVGS+x} ]; then echo -n "'"; echo -n "$VIASH_PAR_HVGS" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "'"; else echo NULL; fi )
)
meta <- list(
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_grn_inference/hvgs",
    "tag" : "build-main"
  },
  "label" : [
    "midtime",
