...
meta = [
    ...
    "arguments" : [
      {
        ...
        "name" : "--rna_r",
        "example" : [
          "resources_test/evaluation_datasets/op_rna.rds"
        ],
        "must_exist" : true,
        "create_parent" : true,
        "required" : false,
      ...
      },
      {
        ...
        "name" : "--atac_r",
        "example" : [
          "resources_test/evaluation_datasets/op_atac.rds"
        ],
        "must_exist" : true,
        "create_parent" : true,
        "required" : false,
      ...
      },
      {
        ...
        "name" : "--cell_topic",
        "default" : [
          "resources_test/prior/cell_topic.csv"
        ],
        "must_exist" : true,
        "create_parent" : true,
        "required" : true,
    ...
    "resources" : [
      {
        ...
        "path" : "script.R",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/task_grn_inference/task_grn_inference/src/methods/multi_omics/figr/"
      }
    ],
    "test_resources" : [
      {
  ...
  "info" : {
    ...
    "platform" : "nextflow",
    "output" : "/home/runner/work/task_grn_inference/task_grn_inference/target/nextflow/grn_methods/figr",
    "viash_version" : "0.8.6",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_grn_inference/grn_methods/figr",
    "tag" : "build-main"
  },
  "label" : [
    "midtime",
