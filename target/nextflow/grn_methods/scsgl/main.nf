...
meta = [
  ...
  "functionality" : {
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/task_grn_inference/task_grn_inference/src/methods/single_omics/scsgl/"
      }
    ],
    "test_resources" : [
      {
    ...
    "info" : {
      ...
      "description" : "GRN inference using SCSGL.\n",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_grn_inference/grn_methods/scsgl",
    "tag" : "build-main"
  },
  "label" : [
    "onedaytime",
