...
meta = [
  ...
  "info" : {
    ...
    "description" : "GRN inference using scPRINT.\n",
...
par = {
  ...
  'how': $( if [ ! -z ${VIASH_PAR_HOW+x} ]; then echo "r'${VIASH_PAR_HOW//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi )
}
meta = {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_grn_inference/grn_methods/scprint",
    "tag" : "build_main"
  },
  "label" : [
    "midtime",
