...
meta = [
    ...
    "resources" : [
      {
        ...
        "path" : "script.R",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/task_grn_benchmark/task_grn_benchmark/src/methods/multi_omics/granie/"
      }
    ],
    "test_resources" : [
      {
  ...
  "info" : {
    "config" : "/home/runner/work/task_grn_benchmark/task_grn_benchmark/src/methods/multi_omics/granie/config.vsh.yaml",
    "platform" : "nextflow",
...
par <- list(
  "multiomics_rna_r" = $( if [ ! -z ${VIASH_PAR_MULTIOMICS_RNA_R+x} ]; then echo -n "'"; echo -n "$VIASH_PAR_MULTIOMICS_RNA_R" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "'"; else echo NULL; fi ),
  "multiomics_atac_r" = $( if [ ! -z ${VIASH_PAR_MULTIOMICS_ATAC_R+x} ]; then echo -n "'"; echo -n "$VIASH_PAR_MULTIOMICS_ATAC_R" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "'"; else echo NULL; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_grn_inference/grn_methods/granie",
    "tag" : "build-main"
  },
  "label" : [
    "midtime",
