...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_grn_inference/task_grn_inference/src/methods/scgpt/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par = {
  ...
  'num_attn_layers': $( if [ ! -z ${VIASH_PAR_NUM_ATTN_LAYERS+x} ]; then echo "int(r'${VIASH_PAR_NUM_ATTN_LAYERS//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
