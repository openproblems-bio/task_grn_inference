...
meta = [
  ...
  "functionality" : {
    ...
    "resources" : [
      {
        ...
        "path" : "script.R",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/task_grn_inference/task_grn_inference/src/methods/single_omics/tigress/"
      }
    ],
    "test_resources" : [
      {
    ...
    "info" : {
      ...
      "description" : "GRN inference using TIGRESS.\n",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_grn_inference/grn_methods/tigress",
    "tag" : "build-main"
  },
  "label" : [
    "threedaystime",
