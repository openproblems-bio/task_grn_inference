...
meta = [
  ...
  "functionality" : {
    ...
    "arguments" : [
      ...
      },
      {
        ...
        "example" : [
          "resources/grn-benchmark/multiomics_rna_d0.h5ad"
        ],
        "must_exist" : true,
        "create_parent" : true,
        "required" : false,
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/task_grn_inference/task_grn_inference/src/process_data/multiomics/format_data/"
      }
    ],
    "info" : {
      "label" : "format_data",
  ...
  "info" : {
    "config" : "/home/runner/work/task_grn_inference/task_grn_inference/src/process_data/multiomics/format_data/config.vsh.yaml",
    "platform" : "nextflow",
...
par = {
  'multiome_counts': $( if [ ! -z ${VIASH_PAR_MULTIOME_COUNTS+x} ]; then echo "r'${VIASH_PAR_MULTIOME_COUNTS//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'multiomics_rna': $( if [ ! -z ${VIASH_PAR_MULTIOMICS_RNA+x} ]; then echo "r'${VIASH_PAR_MULTIOMICS_RNA//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'multiomics_rna_d0': $( if [ ! -z ${VIASH_PAR_MULTIOMICS_RNA_D0+x} ]; then echo "r'${VIASH_PAR_MULTIOMICS_RNA_D0//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'multiomics_rna_d0_hvg': $( if [ ! -z ${VIASH_PAR_MULTIOMICS_RNA_D0_HVG+x} ]; then echo "r'${VIASH_PAR_MULTIOMICS_RNA_D0_HVG//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_grn_inference/multiomics/format_data",
    "tag" : "build-main"
  },
  "label" : [
    "midtime",
