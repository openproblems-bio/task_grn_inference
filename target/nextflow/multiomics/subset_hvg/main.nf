...
meta = [
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/task_grn_inference/task_grn_inference/src/process_data/multiomics/subset_hvg/"
      }
    ],
    "info" : {
      "label" : "subset_hvg",
  ...
  "info" : {
    ...
    "platform" : "nextflow",
    "output" : "/home/runner/work/task_grn_inference/task_grn_inference/target/nextflow/multiomics/subset_hvg",
    "viash_version" : "0.8.6",
...
par = {
  ...
  'multiomics_atac_d0': $( if [ ! -z ${VIASH_PAR_MULTIOMICS_ATAC_D0+x} ]; then echo "r'${VIASH_PAR_MULTIOMICS_ATAC_D0//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi )
}
meta = {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_grn_inference/multiomics/subset_hvg",
    "tag" : "build-main"
  },
  "label" : [
    "midtime",
