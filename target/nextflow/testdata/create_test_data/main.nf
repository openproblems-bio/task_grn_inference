    ...
    "arguments" : [
      {
        ...
        "name" : "--multiomics_rna",
        "example" : [
          "resources_test/inference_datasets/op_rna.h5ad"
        ],
        "must_exist" : true,
        "create_parent" : true,
        "required" : true,
      ...
      },
      {
        ...
        "example" : [
          "resources/inference_datasets/op_atac.h5ad"
        ],
        "must_exist" : true,
        "create_parent" : true,
        "required" : false,
      ...
      },
      {
        ...
        "example" : [
          "resources_test/datasets_raw/op_multiome_counts.h5ad"
        ],
        "must_exist" : true,
        "create_parent" : true,
        "required" : false,
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/task_grn_inference/task_grn_inference/src/process_data/test_data/"
      }
    ],
    "info" : {
...
par = {
  ...
  'multiomics_rna_test': $( if [ ! -z ${VIASH_PAR_MULTIOMICS_RNA_TEST+x} ]; then echo "r'${VIASH_PAR_MULTIOMICS_RNA_TEST//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'multiomics_atac': $( if [ ! -z ${VIASH_PAR_MULTIOMICS_ATAC+x} ]; then echo "r'${VIASH_PAR_MULTIOMICS_ATAC//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'multiomics_atac_test': $( if [ ! -z ${VIASH_PAR_MULTIOMICS_ATAC_TEST+x} ]; then echo "r'${VIASH_PAR_MULTIOMICS_ATAC_TEST//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'perturbation_data': $( if [ ! -z ${VIASH_PAR_PERTURBATION_DATA+x} ]; then echo "r'${VIASH_PAR_PERTURBATION_DATA//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'perturbation_data_test': $( if [ ! -z ${VIASH_PAR_PERTURBATION_DATA_TEST+x} ]; then echo "r'${VIASH_PAR_PERTURBATION_DATA_TEST//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'multiomics_counts': $( if [ ! -z ${VIASH_PAR_MULTIOMICS_COUNTS+x} ]; then echo "r'${VIASH_PAR_MULTIOMICS_COUNTS//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'multiomics_counts_test': $( if [ ! -z ${VIASH_PAR_MULTIOMICS_COUNTS_TEST+x} ]; then echo "r'${VIASH_PAR_MULTIOMICS_COUNTS_TEST//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'perturbation_counts': $( if [ ! -z ${VIASH_PAR_PERTURBATION_COUNTS+x} ]; then echo "r'${VIASH_PAR_PERTURBATION_COUNTS//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'perturbation_counts_test': $( if [ ! -z ${VIASH_PAR_PERTURBATION_COUNTS_TEST+x} ]; then echo "r'${VIASH_PAR_PERTURBATION_COUNTS_TEST//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi )
}
meta = {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_grn_inference/testdata/create_test_data",
    "tag" : "build-main"
  },
  "label" : [
    "midtime",
