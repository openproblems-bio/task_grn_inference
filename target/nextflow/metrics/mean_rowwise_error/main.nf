...
meta = [
  ...
  "functionality" : {
    ...
    "arguments" : [
      ...
      },
      {
        "type" : "string",
        "name" : "--layer",
        "description" : "In which layer to find the normalized data",
        "default" : [
          "lognorm"
        ],
        "required" : false,
    ...
    "resources" : [
      {
        ...
        "path" : "script.R",
        "is_executable" : true,
        "parent" : "file:/mnt/c/Users/nourisa/Documents/testProjs/ongoing/task-grn-benchmark/src/metrics/regression_1/"
      }
    ],
    "test_resources" : [
      {
  ...
  "info" : {
    "config" : "/mnt/c/Users/nourisa/Documents/testProjs/ongoing/task-grn-benchmark/src/metrics/regression_1/config.vsh.yaml",
    "platform" : "nextflow",
    "output" : "/mnt/c/Users/nourisa/Documents/testProjs/ongoing/task-grn-benchmark/target/nextflow/metrics/mean_rowwise_error",
    "viash_version" : "0.8.0",
...
par <- list(
  ...
  "score" = $( if [ ! -z ${VIASH_PAR_SCORE+x} ]; then echo -n "'"; echo -n "$VIASH_PAR_SCORE" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "'"; else echo NULL; fi )
)
meta <- list(
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/metrics/mean_rowwise_error",
    "tag" : "dev"
  },
  "label" : [
    "midtime",
