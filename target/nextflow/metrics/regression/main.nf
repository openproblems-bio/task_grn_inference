...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_grn_inference/task_grn_inference/src/metrics/regression/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "target/nextflow/metrics/regression",
    "viash_version" : "0.9.4",
    "git_commit" : "4c7fa64eda8ac21a61383c2d442d3e87966d27a6",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_grn_inference/metrics/regression",
    "tag" : "build_main"
  },
  "label" : [
    "midtime",
