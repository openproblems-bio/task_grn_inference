...
meta = [
  ...
  "info" : {
    "label" : "TF binding",
    "summary" : "Calculates TF binding scores for a given GRN and dataset",
    "description" : "Calculates TF binding scores for a given GRN and dataset\n",
    "type" : "metrics",
    "type_info" : {
      "label" : "metrics",
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_grn_inference/task_grn_inference/src/metrics/tf_binding/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_grn_inference/metrics/tf_binding",
    "tag" : "build_main"
  },
  "label" : [
    "midtime",
