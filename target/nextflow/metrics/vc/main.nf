...
meta = [
  ...
  "info" : {
    "label" : "Virtual Cell",
    "summary" : "Predicts gene expression for OOD conditions using encoded perturbation and control expression",
    "type" : "metrics",
    "type_info" : {
      "label" : "metrics",
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_grn_inference/task_grn_inference/src/metrics/vc/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "target/nextflow/metrics/vc",
    "viash_version" : "0.9.4",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_grn_inference/metrics/vc",
    "tag" : "build_main"
  },
  "label" : [
    "midtime",
