...
meta = [
    ...
    "arguments" : [
      {
        ...
        "example" : [
          "resources/grn-benchmark/perturbation.h5ad"
        ],
        "must_exist" : true,
        "create_parent" : true,
        "required" : true,
      ...
      },
      {
        ...
        "example" : [
          "resources/grn-benchmark/score.h5ad"
        ],
        "must_exist" : true,
        "create_parent" : true,
        "required" : true,
  ...
  "info" : {
    ...
    "platform" : "nextflow",
    "output" : "/mnt/c/Users/nourisa/Documents/testProjs/ongoing/task-grn-benchmark/target/nextflow/metrics/regression_1",
    "viash_version" : "0.8.0",
...
par = {
  'perturbation_h5ad': $( if [ ! -z ${VIASH_PAR_PERTURBATION_H5AD+x} ]; then echo "r'${VIASH_PAR_PERTURBATION_H5AD//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/metrics/regression_1",
    "tag" : "dev"
  },
  "label" : [
    "midtime",
