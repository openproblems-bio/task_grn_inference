...
meta = [
  ...
  "info" : {
    ...
    "summary" : "Anchor regression metric for evaluating model robustness",
    "type" : "metrics",
    "type_info" : {
      "label" : "metrics",
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_grn_inference/task_grn_inference/src/metrics/anchor_regression/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "target/nextflow/metrics/anchor_regression",
    "viash_version" : "0.9.4",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_grn_inference/metrics/anchor_regression",
    "tag" : "build_main"
  },
  "label" : [
    "midtime",
