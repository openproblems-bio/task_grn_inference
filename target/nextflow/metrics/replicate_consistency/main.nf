// replicate_consistency build_main
// 
...
meta = [
  ...
  "info" : {
    "label" : "Replica Consistency TF Activity",
    "summary" : "Replicate consistency of TF activity scores",
    "type" : "metrics",
    "type_info" : {
      "label" : "metrics",
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_grn_inference/task_grn_inference/src/metrics/replicate_consistency/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "target/nextflow/metrics/replicate_consistency",
    "viash_version" : "0.9.4",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_grn_inference/metrics/replicate_consistency",
    "tag" : "build_main"
  },
  "label" : [
    "midtime",
