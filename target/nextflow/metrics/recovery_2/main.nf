...
meta = [
  ...
  "info" : {
    "label" : "Recovery 2",
    "summary" : "Calculates consistency in the recovery of perturbation across replica",
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_grn_inference/task_grn_inference/src/metrics/recovery_2/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_grn_inference/metrics/recovery_2",
    "tag" : "build_main"
  },
  "label" : [
    "midtime",
