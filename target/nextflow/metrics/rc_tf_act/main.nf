...
meta = [
  ...
  "info" : {
    ...
    "summary" : "Replica consistency of TF activity scores",
    "type" : "metrics",
    "type_info" : {
      "label" : "metrics",
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_grn_inference/task_grn_inference/src/metrics/rc_tf_act/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_grn_inference/metrics/rc_tf_act",
    "tag" : "build_main"
  },
  "label" : [
    "midtime",
