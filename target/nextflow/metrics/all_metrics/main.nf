...
meta = [
  ...
  "info" : {
    "label" : "All metrics",
    "summary" : "A wrapper component to compute all metrics",
    "type" : "metrics",
    "type_info" : {
      "label" : "metrics",
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_grn_inference/task_grn_inference/src/metrics/all_metrics/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "target/nextflow/metrics/all_metrics",
    "viash_version" : "0.9.4",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_grn_inference/metrics/all_metrics",
    "tag" : "build_main"
  },
  "label" : [
    "midtime",
