...
meta = [
    ...
    "arguments" : [
      {
        ...
        "example" : [
          "resources/prior/gene_annotations.txt"
        ],
        "must_exist" : true,
        "create_parent" : true,
        "required" : false,
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/task_grn_inference/task_grn_inference/src/process_data/explanatory_analysis/gene_annotation/"
      }
    ],
    "info" : {
  ...
  "info" : {
    "config" : "/home/runner/work/task_grn_inference/task_grn_inference/src/process_data/explanatory_analysis/gene_annotation/config.vsh.yaml",
    "platform" : "nextflow",
...
par = {
  'gene_annotations': $( if [ ! -z ${VIASH_PAR_GENE_ANNOTATIONS+x} ]; then echo "r'${VIASH_PAR_GENE_ANNOTATIONS//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi )
}
meta = {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_grn_inference/exp_analysis/gene_annotation",
    "tag" : "build-main"
  },
  "label" : [
    "midtime",
