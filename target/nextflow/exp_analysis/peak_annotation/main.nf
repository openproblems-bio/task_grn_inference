...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_grn_inference/task_grn_inference/src/exp_analysis/peak_annotation/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par <- list(
  ...
  "annot_peak_database" = $( if [ ! -z ${VIASH_PAR_ANNOT_PEAK_DATABASE+x} ]; then echo -n "'"; echo -n "$VIASH_PAR_ANNOT_PEAK_DATABASE" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "'"; else echo NULL; fi )
)
meta <- list(
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_grn_inference/exp_analysis/peak_annotation",
    "tag" : "build_main"
  },
  "label" : [
    "midtime",
