...
meta = [
  ...
  "functionality" : {
    ...
    "arguments" : [
      ...
      },
      {
        "type" : "file",
        "name" : "--prior_data",
        "description" : "Prior information used for grn inference.",
        "info" : {
          "label" : "prior data",
          "summary" : "Prior data used for grn benchmark",
          "file_type" : "h5ad",
          "slots" : {
            "uns" : [
              {
                "type" : "list",
                "name" : "tf_list",
                "description" : "List of known tfs obtained from https://resources.aertslab.org/cistarget.",
                "required" : true
              }
            ]
          }
        ...
        "example" : [
          "resources/grn-benchmark/prior_data.h5ad"
        ],
        "must_exist" : true,
        "create_parent" : true,
        "required" : false,
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/mnt/c/Users/nourisa/Documents/testProjs/ongoing/task-grn-benchmark/src/control_methods/positive_control/"
      }
    ],
    "test_resources" : [
      {
    ...
    "info" : {
      ...
      "description" : "By directly training on perturbation data, positive control is expected to learn more accurate tf-gene connections.\n",
      "type" : "control_method",
      "type_info" : {
  ...
  "info" : {
    "config" : "/mnt/c/Users/nourisa/Documents/testProjs/ongoing/task-grn-benchmark/src/control_methods/positive_control/config.vsh.yaml",
    "platform" : "nextflow",
    "output" : "/mnt/c/Users/nourisa/Documents/testProjs/ongoing/task-grn-benchmark/target/nextflow/control_methods/positive_control",
    "viash_version" : "0.8.0",
...
par = {
  ...
  'prior_data': $( if [ ! -z ${VIASH_PAR_PRIOR_DATA+x} ]; then echo "r'${VIASH_PAR_PRIOR_DATA//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/control_methods/positive_control",
    "tag" : "dev"
  },
  "label" : [
    "midtime",
