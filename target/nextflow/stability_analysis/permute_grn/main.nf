...
meta = [
  ...
  "info" : {
    ...
    "description" : "We add different intensities of permutation to the GRN to test the sensitivity of the evaluation metrics. \nThe permutations are applied to TF-gene link, direction, sign, and weight.\n"
  },
  "status" : "enabled",
  "scope" : {
    "image" : "public",
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_grn_inference/task_grn_inference/src/stability_analysis/permute_grn/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par = {
  ...
  'prediction_n': $( if [ ! -z ${VIASH_PAR_PREDICTION_N+x} ]; then echo "r'${VIASH_PAR_PREDICTION_N//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'degree': $( if [ ! -z ${VIASH_PAR_DEGREE+x} ]; then echo "int(r'${VIASH_PAR_DEGREE//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'noise_type': $( if [ ! -z ${VIASH_PAR_NOISE_TYPE+x} ]; then echo "r'${VIASH_PAR_NOISE_TYPE//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi )
}
meta = {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_grn_inference/stability_analysis/permute_grn",
    "tag" : "build_main"
  },
  "label" : [
    "midtime",
