...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_grn_inference/task_grn_inference/src/stability_analysis/skeleton/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par = {
  ...
  'flank_length': $( if [ ! -z ${VIASH_PAR_FLANK_LENGTH+x} ]; then echo "int(r'${VIASH_PAR_FLANK_LENGTH//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'skeleton': $( if [ ! -z ${VIASH_PAR_SKELETON+x} ]; then echo "r'${VIASH_PAR_SKELETON//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'motif_dataset_encode': $( if [ ! -z ${VIASH_PAR_MOTIF_DATASET_ENCODE+x} ]; then echo "r'${VIASH_PAR_MOTIF_DATASET_ENCODE//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'motif_dataset_jaspar': $( if [ ! -z ${VIASH_PAR_MOTIF_DATASET_JASPAR+x} ]; then echo "r'${VIASH_PAR_MOTIF_DATASET_JASPAR//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi )
}
meta = {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_grn_inference/stability_analysis/create_skeleton",
    "tag" : "build_main"
  },
  "label" : [
    "midtime",
