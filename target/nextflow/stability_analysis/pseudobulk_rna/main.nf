...
meta = [
  ...
  "info" : {
    ...
    "description" : "We pseudobulk the scRNA data to test the sensitivity of the evaluation metrics.\n"
  },
  "status" : "enabled",
  "scope" : {
    "image" : "public",
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_grn_inference/task_grn_inference/src/stability_analysis/pseudobulk/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "target/nextflow/stability_analysis/pseudobulk_rna",
    "viash_version" : "0.9.4",
...
par = {
  ...
  'rna_pseudobulked': $( if [ ! -z ${VIASH_PAR_RNA_PSEUDOBULKED+x} ]; then echo "r'${VIASH_PAR_RNA_PSEUDOBULKED//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'granularity': $( if [ ! -z ${VIASH_PAR_GRANULARITY+x} ]; then echo "float(r'${VIASH_PAR_GRANULARITY//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_grn_inference/stability_analysis/pseudobulk_rna",
    "tag" : "build_main"
  },
  "label" : [
    "midtime",
