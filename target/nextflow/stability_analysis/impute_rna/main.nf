...
meta = [
  ...
  "info" : {
    ...
    "description" : "We impute the missing values in scRNA data to test the sensitivity of the evaluation metrics.\n"
  },
  "status" : "enabled",
  "scope" : {
    "image" : "public",
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_grn_inference/task_grn_inference/src/stability_analysis/imputation/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "target/nextflow/stability_analysis/impute_rna",
    "viash_version" : "0.9.4",
...
par = {
  ...
  'rna_imputed': $( if [ ! -z ${VIASH_PAR_RNA_IMPUTED+x} ]; then echo "r'${VIASH_PAR_RNA_IMPUTED//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'imputation': $( if [ ! -z ${VIASH_PAR_IMPUTATION+x} ]; then echo "r'${VIASH_PAR_IMPUTATION//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_grn_inference/stability_analysis/impute_rna",
    "tag" : "build_main"
  },
  "label" : [
    "midtime",
