// explanatory_analysis build-main
// 
  ...
  "functionality" : {
    ...
    "arguments" : [
      ...
      },
      {
        ...
        "default" : [
          "resources/grn-benchmark/supp/annot_peak_database.csv"
        ],
        "must_exist" : true,
        "create_parent" : true,
        "required" : true,
      ...
      },
      {
        ...
        "default" : [
          "resources/grn-benchmark/supp/annot_gene_database.csv"
        ],
        "must_exist" : true,
        "create_parent" : true,
        "required" : true,
...
par = {
  ...
  'tf_gene_net': $( if [ ! -z ${VIASH_PAR_TF_GENE_NET+x} ]; then echo "r'${VIASH_PAR_TF_GENE_NET//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'peak_gene_net': $( if [ ! -z ${VIASH_PAR_PEAK_GENE_NET+x} ]; then echo "r'${VIASH_PAR_PEAK_GENE_NET//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'annot_peak_database': $( if [ ! -z ${VIASH_PAR_ANNOT_PEAK_DATABASE+x} ]; then echo "r'${VIASH_PAR_ANNOT_PEAK_DATABASE//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'annot_gene_database': $( if [ ! -z ${VIASH_PAR_ANNOT_GENE_DATABASE+x} ]; then echo "r'${VIASH_PAR_ANNOT_GENE_DATABASE//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi )
}
meta = {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_grn_inference/explanatory_analysis",
    "tag" : "build-main"
  },
  "label" : [
    "midtime",
