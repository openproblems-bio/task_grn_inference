  ...
  "functionality" : {
    ...
    "arguments" : [
      ...
      },
      {
        ...
        "name" : "--peak_gene_net",
        "example" : [
          "resources_test/peak_gene_models/collectri.csv"
        ],
        "must_exist" : true,
        "create_parent" : true,
        "required" : false,
      ...
      },
      {
        ...
        "example" : [
          "resources_test/supplementary/annot_peak_database.csv"
        ],
        "must_exist" : false,
        "create_parent" : true,
        "required" : false,
