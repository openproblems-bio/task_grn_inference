...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_grn_inference/task_grn_inference/src/process_data/adamson/config.vsh.yaml",
    "runner" : "nextflow",
...
par = {
  'adamson_raw': $( if [ ! -z ${VIASH_PAR_ADAMSON_RAW+x} ]; then echo "r'${VIASH_PAR_ADAMSON_RAW//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'adamson_bulk': $( if [ ! -z ${VIASH_PAR_ADAMSON_BULK+x} ]; then echo "r'${VIASH_PAR_ADAMSON_BULK//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'adamson_test_sc': $( if [ ! -z ${VIASH_PAR_ADAMSON_TEST_SC+x} ]; then echo "r'${VIASH_PAR_ADAMSON_TEST_SC//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'adamson_test_bulk': $( if [ ! -z ${VIASH_PAR_ADAMSON_TEST_BULK+x} ]; then echo "r'${VIASH_PAR_ADAMSON_TEST_BULK//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'adamson_train_sc': $( if [ ! -z ${VIASH_PAR_ADAMSON_TRAIN_SC+x} ]; then echo "r'${VIASH_PAR_ADAMSON_TRAIN_SC//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'adamson_train_sc_test': $( if [ ! -z ${VIASH_PAR_ADAMSON_TRAIN_SC_TEST+x} ]; then echo "r'${VIASH_PAR_ADAMSON_TRAIN_SC_TEST//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'adamson_test_bulk_test': $( if [ ! -z ${VIASH_PAR_ADAMSON_TEST_BULK_TEST+x} ]; then echo "r'${VIASH_PAR_ADAMSON_TEST_BULK_TEST//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'adamson_test_sc_test': $( if [ ! -z ${VIASH_PAR_ADAMSON_TEST_SC_TEST+x} ]; then echo "r'${VIASH_PAR_ADAMSON_TEST_SC_TEST//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi )
}
meta = {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_grn_inference/process_data/adamon",
    "tag" : "build_main"
  },
  "label" : [
    "midtime",
