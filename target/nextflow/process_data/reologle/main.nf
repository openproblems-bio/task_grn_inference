...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_grn_inference/task_grn_inference/src/process_data/replogle/config.vsh.yaml",
    "runner" : "nextflow",
...
par = {
  'replogle_raw': $( if [ ! -z ${VIASH_PAR_REPLOGLE_RAW+x} ]; then echo "r'${VIASH_PAR_REPLOGLE_RAW//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'tf_all': $( if [ ! -z ${VIASH_PAR_TF_ALL+x} ]; then echo "r'${VIASH_PAR_TF_ALL//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'replogle_bulk': $( if [ ! -z ${VIASH_PAR_REPLOGLE_BULK+x} ]; then echo "r'${VIASH_PAR_REPLOGLE_BULK//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'replogle_test_bulk': $( if [ ! -z ${VIASH_PAR_REPLOGLE_TEST_BULK+x} ]; then echo "r'${VIASH_PAR_REPLOGLE_TEST_BULK//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'replogle_train_bulk': $( if [ ! -z ${VIASH_PAR_REPLOGLE_TRAIN_BULK+x} ]; then echo "r'${VIASH_PAR_REPLOGLE_TRAIN_BULK//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_grn_inference/process_data/reologle",
    "tag" : "build_main"
  },
  "label" : [
    "midtime",
