...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_grn_inference/task_grn_inference/src/process_data/replogle_k562_gwps/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker|native",
    "output" : "target/nextflow/process_data/reologle_k562_gwps",
    "viash_version" : "0.9.4",
...
par = {
  'replogle_gwps': $( if [ ! -z ${VIASH_PAR_REPLOGLE_GWPS+x} ]; then echo "r'${VIASH_PAR_REPLOGLE_GWPS//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'tf_all': $( if [ ! -z ${VIASH_PAR_TF_ALL+x} ]; then echo "r'${VIASH_PAR_TF_ALL//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'replogle_test_perturbs': $( if [ ! -z ${VIASH_PAR_REPLOGLE_TEST_PERTURBS+x} ]; then echo "r'${VIASH_PAR_REPLOGLE_TEST_PERTURBS//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'replogle_gwps_test_sc': $( if [ ! -z ${VIASH_PAR_REPLOGLE_GWPS_TEST_SC+x} ]; then echo "r'${VIASH_PAR_REPLOGLE_GWPS_TEST_SC//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'replogle_gwps_train_sc': $( if [ ! -z ${VIASH_PAR_REPLOGLE_GWPS_TRAIN_SC+x} ]; then echo "r'${VIASH_PAR_REPLOGLE_GWPS_TRAIN_SC//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'replogle_gwps_train_sc_subset': $( if [ ! -z ${VIASH_PAR_REPLOGLE_GWPS_TRAIN_SC_SUBSET+x} ]; then echo "r'${VIASH_PAR_REPLOGLE_GWPS_TRAIN_SC_SUBSET//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi )
}
meta = {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_grn_inference/process_data/reologle_k562_gwps",
    "tag" : "build_main"
  },
  "label" : [
    "midtime",
