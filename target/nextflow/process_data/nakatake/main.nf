...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_grn_inference/task_grn_inference/src/process_data/nakatake/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker|native",
    "output" : "target/nextflow/process_data/nakatake",
    "viash_version" : "0.9.1",
...
par = {
  'nakatake_raw': $( if [ ! -z ${VIASH_PAR_NAKATAKE_RAW+x} ]; then echo "r'${VIASH_PAR_NAKATAKE_RAW//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'nakatake_bulk': $( if [ ! -z ${VIASH_PAR_NAKATAKE_BULK+x} ]; then echo "r'${VIASH_PAR_NAKATAKE_BULK//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'nakatake_test_bulk': $( if [ ! -z ${VIASH_PAR_NAKATAKE_TEST_BULK+x} ]; then echo "r'${VIASH_PAR_NAKATAKE_TEST_BULK//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'nakatake_train_bulk': $( if [ ! -z ${VIASH_PAR_NAKATAKE_TRAIN_BULK+x} ]; then echo "r'${VIASH_PAR_NAKATAKE_TRAIN_BULK//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi )
}
meta = {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_grn_inference/process_data/nakatake",
    "tag" : "build_main"
  },
  "label" : [
    "midtime",
