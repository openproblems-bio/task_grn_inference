...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_grn_inference/task_grn_inference/src/process_data/norman/config.vsh.yaml",
    "runner" : "nextflow",
...
par = {
  'norman_raw': $( if [ ! -z ${VIASH_PAR_NORMAN_RAW+x} ]; then echo "r'${VIASH_PAR_NORMAN_RAW//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'norman_bulk': $( if [ ! -z ${VIASH_PAR_NORMAN_BULK+x} ]; then echo "r'${VIASH_PAR_NORMAN_BULK//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'norman_test_sc': $( if [ ! -z ${VIASH_PAR_NORMAN_TEST_SC+x} ]; then echo "r'${VIASH_PAR_NORMAN_TEST_SC//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'norman_test_bulk': $( if [ ! -z ${VIASH_PAR_NORMAN_TEST_BULK+x} ]; then echo "r'${VIASH_PAR_NORMAN_TEST_BULK//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'norman_train_sc': $( if [ ! -z ${VIASH_PAR_NORMAN_TRAIN_SC+x} ]; then echo "r'${VIASH_PAR_NORMAN_TRAIN_SC//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi )
}
meta = {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_grn_inference/process_data/norman",
    "tag" : "build_main"
  },
  "label" : [
    "midtime",
