...
meta = [
  ...
  "functionality" : {
    ...
    "arguments" : [
      ...
      },
      {
        ...
        "example" : [
          "resources/grn-benchmark/supp/cell_topic.csv"
        ],
        "must_exist" : true,
        "create_parent" : true,
        "required" : true,
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/task_grn_benchmark/task_grn_benchmark/src/methods/pycistopic/"
      }
    ],
    "info" : {
      "label" : "pycistopic",
      "summary" : "Cis-regulatory topic modeling using pycisTopic",
      "description" : "Cis-regulatory topic modeling using pycisTopic.\n",
  ...
  "info" : {
    "config" : "/home/runner/work/task_grn_benchmark/task_grn_benchmark/src/methods/pycistopic/config.vsh.yaml",
    "platform" : "nextflow",
    "output" : "/home/runner/work/task_grn_benchmark/task_grn_benchmark/target/nextflow/pycistopic",
    "viash_version" : "0.8.6",
...
par = {
  ...
  'out_dir': $( if [ ! -z ${VIASH_PAR_OUT_DIR+x} ]; then echo "r'${VIASH_PAR_OUT_DIR//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_grn_inference/pycistopic",
    "tag" : "build-main"
  },
  "label" : [
    "midtime",
