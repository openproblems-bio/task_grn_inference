...
meta = [
  ...
  "info" : {
    ...
    "platform" : "nextflow",
    "output" : "/home/runner/work/task_grn_benchmark/task_grn_benchmark/target/nextflow/multiome_matrix",
    "viash_version" : "0.8.6",
...
par = {
  ...
  'rna_matrix': $( if [ ! -z ${VIASH_PAR_RNA_MATRIX+x} ]; then echo "r'${VIASH_PAR_RNA_MATRIX//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'atac_matrix': $( if [ ! -z ${VIASH_PAR_ATAC_MATRIX+x} ]; then echo "r'${VIASH_PAR_ATAC_MATRIX//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'rna_gene_annot': $( if [ ! -z ${VIASH_PAR_RNA_GENE_ANNOT+x} ]; then echo "r'${VIASH_PAR_RNA_GENE_ANNOT//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'rna_cell_annot': $( if [ ! -z ${VIASH_PAR_RNA_CELL_ANNOT+x} ]; then echo "r'${VIASH_PAR_RNA_CELL_ANNOT//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'atac_peak_annot': $( if [ ! -z ${VIASH_PAR_ATAC_PEAK_ANNOT+x} ]; then echo "r'${VIASH_PAR_ATAC_PEAK_ANNOT//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'atac_cell_annot': $( if [ ! -z ${VIASH_PAR_ATAC_CELL_ANNOT+x} ]; then echo "r'${VIASH_PAR_ATAC_CELL_ANNOT//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi )
}
meta = {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_grn_inference/multiome_matrix",
    "tag" : "build-main"
  },
  "label" : [
    "midtime",
