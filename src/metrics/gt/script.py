...
par = {
    ...
    'dataset_name': f'resources/grn_benchmark/inference_data/beeline_hESC.h5ad',
...
if __name__ == "__main__":
    ...
    os.makedirs(os.path.dirname(par['score']), exist_ok=True)
