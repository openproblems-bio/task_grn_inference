viash run src/process_data/test_data/config.novsh.yaml -- \
    ...
    --perturbation_data resources/grn_benchmark/evaluation_datasets/op_perturbation.h5ad --perturbation_data_test resources_test/grn_benchmark/evaluation_datasets/op_perturbation.h5ad \
